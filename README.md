...
| C#         | `.sln`/`.slnx`/`.csproj` or any `.cs` source (ASP.NET Core attribute routing + minimal APIs; `partial` types merged across files; project-wide name resolution) |
